...
build_time_vars = {
    ...
    'CONFIG_ARGS': "'--prefix=/opt' '--enable-optimizations' '--with-openssl=/opt' '--with-openssl-rpath=auto' '--with-ensurepip=install'",
    'CONFINCLUDEDIR': '/opt/include',
    'CONFINCLUDEPY': '/opt/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/Users/pjobson/code/Python-3.14.5/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/Users/pjobson/code/Python-3.14.5/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.14 LCOV report [commit $(shell )]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'clang++',
    'DESTDIRS': '/opt /opt/lib /opt/lib/python3.14 /opt/lib/python3.14/lib-dynload',
    'DESTLIB': '/opt/lib/python3.14',
    'DESTPATH': '',
    'DESTSHARED': '/opt/lib/python3.14/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'INCLDIRSTOMAKE': '/opt/include /opt/include /opt/include/python3.14 /opt/include/python3.14',
    'INCLUDEDIR': '/opt/include',
    'INCLUDEPY': '/opt/include/python3.14',
    'INSTALL': '/opt/bin/install -c',
    'INSTALL_DATA': '/opt/bin/install -c -m 644',
    'INSTALL_MIMALLOC': 'yes',
    'INSTALL_PROGRAM': '/opt/bin/install -c',
    'INSTALL_SCRIPT': '/opt/bin/install -c',
    'INSTALL_SHARED': '/opt/bin/install -c -m 755',
    ...
    'LDVERSION': '3.14',
    'LIBC': '',
    'LIBDEST': '/opt/lib/python3.14',
    'LIBDIR': '/opt/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/Users/pjobson/code/Python-3.14.5/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBPL': '/opt/lib/python3.14/config-3.14-darwin',
    'LIBPYTHON': '',
    ...
    'MACHDEP': 'darwin',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/lib/python3.14',
    ...
    'MODULE__CTYPES_CFLAGS': '-fno-strict-overflow -I/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/ffi -DUSING_APPLE_OS_LIBFFI=1 -DUSING_MALLOC_CLOSURE_DOT_C=1',
    ...
    'MODULE__CTYPES_TEST_CFLAGS': '-I/Library/Developer/CommandLineTools/SDKs/MacOSX10.14.sdk/usr/include/ffi -DUSING_APPLE_OS_LIBFFI=1 -DUSING_MALLOC_CLOSURE_DOT_C=1',
    ...
    'MODULE__HASHLIB_CFLAGS': '-I/opt/include',
    'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
    'MODULE__HASHLIB_LDFLAGS': '-L/opt/lib  -Wl,-rpath,/opt/lib  -lcrypto',
    ...
    'MODULE__LZMA_CFLAGS': '-I/opt/include',
    'MODULE__LZMA_LDFLAGS': '-L/opt/lib -llzma',
    ...
    'MODULE__SRE_LDFLAGS': '',
    'MODULE__SSL_CFLAGS': '-I/opt/include',
    ...
    'MODULE__SSL_LDFLAGS': '-L/opt/lib  -Wl,-rpath,/opt/lib -lssl -lcrypto',
    ...
    'MODULE__UUID_CFLAGS': '-I/opt/include/uuid',
    'MODULE__UUID_LDFLAGS': '-L/opt/lib -luuid',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/Users/pjobson/code/Python-3.14.5/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall',
    'PY_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/Users/pjobson/code/Python-3.14.5/code.profclangd -I./Include/internal -I./Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/Users/pjobson/code/Python-3.14.5/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '',
    ...
    'abs_builddir': '/Users/pjobson/code/Python-3.14.5',
    'abs_srcdir': '/Users/pjobson/code/Python-3.14.5',
    'datarootdir': '/opt/share',
    'exec_prefix': '/opt',
    'host_exec_prefix': '/opt',
    'host_prefix': '/opt',
    'prefix': '/opt',
    'srcdir': '.',
}
